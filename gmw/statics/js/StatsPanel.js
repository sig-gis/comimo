class StatsPanel extends React.Component {
            ...
            .then(
                res => {
                    ...
                    if (nonzero) {
                        ...
                        var options = {
                            title:
                                "From " + res.names[0] + " to " + res.names[res.names.length - 1],
                            width: 290,
                            height: 200,
                            legend: {position: "none"},
    ...
    render() {
        if (!USER_STATE) {
            ...
            var content = (
                <div>
                    <b># per subscribed regions </b>
                    <br />
                    Note: Regions with no mines are not shown. Please subscribe to more regions to
                    view area of mines predicted within.
                    <div id="stats1">
                        <b>Loading data...</b>
                    </div>
                    ...
                    <small>
                        {" "}
                        Note: each prediction equals an area of 540x540m. Mining activity is not
                        always present in the entire prediction area{" "}
                    </small>
                </div>
            );
        }
