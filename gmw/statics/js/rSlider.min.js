!(function () {
    const t = function (t) {
        ...
        for (const i in this.conf) t.hasOwnProperty(i) && (this.conf[i] = t[i]);
        this.init();
    };
    ...
    (t.prototype.createScale = function (t) {
        ...
        for (let e = 0, s = this.conf.values.length; e < s; e++) {
            ...
            this.conf.labels
                ...
                : (e !== 0 && e !== s - 1) || (l.innerHTML = this.conf.values[e]),
    ...
    (t.prototype.addEvents = function () {
        const t = this.slider.querySelectorAll("." + this.cls.pointer);
        const i = this.slider.querySelectorAll("span");
    ...
    (t.prototype.drag = function (t) {
        if ((t.preventDefault(), !this.conf.disabled)) {
            const i = t.target.getAttribute("data-dir");
            return (
    ...
    (t.prototype.move = function (t) {
        if (this.activePointer && !this.conf.disabled) {
            let i = (t.type === "touchmove" ? t.touches[0].clientX : t.pageX)
                    - this.sliderLeft
                    - this.pointerWidth / 2;
            return (
    ...
    (t.prototype.onChange = function () {
        ...
        (this.timeout = setTimeout(() => {
            if (t.conf.onChange && typeof t.conf.onChange == "function") return t.conf.onChange(t.input.value);
        }, 500));
    }),
    ...
    var i = function (t, i, e) {
        ...
        return (
            i && (s.className = i),
            e && e.length === 2 && s.setAttribute("data-" + e[0], e[1]),
            s
        );
    };
    ...
    var s = function (t) {
        const i = [];
        const e = t.values.max - t.values.min;
