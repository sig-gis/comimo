    ...
    return (
      <>
        <div>
          ...
          >
            {selectedDate === -1 && (
              <option key={-1} value={-1}>
                {predictions.length > 0 ? "Select Date..." : "Loading Dates..."}
              </option>
            )}
            {predictions.map((d) => (
          ...
          <Button disabled={selectedDate === -1} onClick={() => this.loadDateData(selectedDate)}>
      ...
      <>
        <div>
          ...
          >
            {selectedDate === -1 && (
              <option key={-1} value={-1}>
                {userMines.length > 0 ? "Select Date..." : "Loading Dates..."}
              </option>
            )}
            {userMines.map((d) => (
              <option key={d} value={d}>
