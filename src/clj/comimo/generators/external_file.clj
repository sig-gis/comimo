(ns comimo.generators.external-file
  (:require [clojure.string     :as str]
            ...
            [comimo.utils.geom    :refer [make-wkt-point]]
            [comimo.utils.project :refer [check-plot-limits check-sample-limits]]))
...
(defmethod get-file-data :default [distribution _ _ _]
  (throw (str "No such distribution (" distribution ") defined for comimo.db.projects/get-file-data")))
